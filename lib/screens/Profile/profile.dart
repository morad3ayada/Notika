...
class ProfileScreen extends StatelessWidget {
  ...
  final List<Map<String, dynamic>> classes = [
    {"name": "الأول متوسط", "icon": Icons.looks_one, "color": Color(0xFF1976D2)},
    {"name": "الثاني متوسط", "icon": Icons.looks_two, "color": Color(0xFF43A047)},
    {"name": "الثالث متوسط", "icon": Icons.looks_3, "color": Color(0xFFFFC107)},
  ];
